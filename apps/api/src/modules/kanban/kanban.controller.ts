...
export const listWorkspaceBoards = asyncHandler(async (req, res) => res.json({ success: true, data: await service.listWorkspaceBoards(userId(req), req.params.workspaceId) }));
